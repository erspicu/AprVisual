...
**Result: 125 PASS / 16 FAIL / 0 timeouts — and every FAIL is root-caused** into six categories: power-on state, CPU÷12/PPU÷4 clock-phase alignment, unmodeled analog decay, open-bus residuals, APU/DMA detail timing, and unofficial-opcode behavior.
