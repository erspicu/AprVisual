...
const I18N = {
  zh: {
    ...
    flat: "≈持平", dup: "重打包", dupNote: (g, raw) => `↻ 同 ${g} 引擎(IL 指紋相同)· 圖表採組內最佳 · 本版實測 ${fmt(raw)}`,
  ...
  en: {
    ...
    flat: "≈flat", dup: "repackage", dupNote: (g, raw) => `↻ same engine as ${g} (identical IL fingerprint) · chart uses the group best · this build measured ${fmt(raw)}`,
