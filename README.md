...
Infrastructure in `tools/testrom/`: catalog-driven parallel runner (`run_tests.py`, resume-aware, per-test timing fields), the AprNes calibration oracle (`calibrate_ref.py`), and the self-contained report generator (`build_report.py`).
