...
<div class="note"><strong>Scope:</strong> 93 NROM / NTSC test ROMs judged via the blargg <code>$6000</code> protocol
 (classes A, A-r) or on-screen CRC (class C). Screen-text ROMs (46, class B) are a later phase.
