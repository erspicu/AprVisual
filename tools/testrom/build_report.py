...
<div class="note"><span class="en"><strong>Scope:</strong> 141 NROM/CNROM NTSC test ROMs. Detection runs once per simulated frame
 ...
 <details style="margin-top:.6rem">
  ...
  <div style="margin-top:.5rem">🔬 <span class="en"><strong>How these shims are built without breaking other tests</strong> &mdash; a teaching write-up on the probe effect (why a <em>zero-fire</em> graph edit flipped an unrelated test) and Gemini&#39;s instrument-grade force/release principle:
   <a href="https://github.com/erspicu/AprVisual/blob/main/MD/testrom/2026-07-08-probe-effect-instrument-grade-shims.en.md" target="_blank" rel="noopener">Don&#39;t Touch the DUT &mdash; probe effect &amp; instrument-grade shims (EN)</a>.</span><span class="zh"><strong>這些 shim 怎麼掛才不會弄壞別的測試</strong> —— 一篇教學:探針效應(一個「零開火」的圖變更為何弄壞無關測試)與 Gemini 的儀器級 force/release 通則:
   <a href="https://github.com/erspicu/AprVisual/blob/main/MD/testrom/2026-07-08-probe-effect-instrument-grade-shims.md" target="_blank" rel="noopener">別動被測物 —— 探針效應與儀器級 shim(繁中)</a>。</span></div>
